...
var salles = [new salle("0","0", "Gardien",new salle_position(-87.5,61,0),new salle_size(175,125,100),salle_form.Square,salle_direction.Vertical),
			  ...
			  new salle("3","002", "002",new salle_position(507,-623,0),new salle_size(100,75,100), salle_form.Square, salle_direction.Oblique),
			  new salle("4","003", "003",new salle_position(507,-698,0),new salle_size(100,75,100), salle_form.Square, salle_direction.Oblique),
			  new salle("5","004", "004",new salle_position(357,-698,0),new salle_size(200,75,100), salle_form.Square, salle_direction.Oblique),
			  ...
			  new salle("10","016","BDE",new salle_position(462.5,105,0),new salle_size(75,140,100),salle_form.Square,salle_direction.Horizontal),
			            //"11
			  new salle("12","0", "CauchermUr",new salle_position(-87.5,61,101.5),new salle_size(175,125,100),salle_form.Square,salle_direction.Vertical),
			  new salle("13","101", "101",new salle_position(-200,61,101.5),new salle_size(50,125,100),salle_form.Square,salle_direction.Vertical),
			  new salle("14","102", "102",new salle_position(-262.5,49,101.5),new salle_size(75,101,100),salle_form.Square,salle_direction.Vertical),
			  new salle("15","103", "103",new salle_position(-330,49,101.5),new salle_size(60,101,100),salle_form.Square,salle_direction.Vertical),
			  new salle("16","104", "104",new salle_position(-422.5,61,101.5),new salle_size(125,125,100),salle_form.Square,salle_direction.Vertical),
			  new salle("17","105", "105",new salle_position(-522.5,49,101.5),new salle_size(75,101,100),salle_form.Square,salle_direction.Vertical),
			  new salle("18","106", "106",new salle_position(-630,49,101.5),new salle_size(140,101,100),salle_form.Trapezoid,salle_direction.Vertical),
			  new salle("19","107", "107",new salle_position(-560.5,202.5 + v2,101.5),new salle_size(145,105,100),salle_form.Trapezoid,salle_direction.Vertical),
			  new salle("20","108", "108",new salle_position(-420,202.5 + v2,101.5),new salle_size(135,105,100),salle_form.Square,salle_direction.Vertical),
			  new salle("21","109", "109",new salle_position(-292.5,202.5 + v2,101.5),new salle_size(120,105,100),salle_form.Square,salle_direction.Vertical),
			  new salle("22","110", "110",new salle_position(507.5,-660,101.5),new salle_size(100,150,100), salle_form.Square, salle_direction.Oblique),
			  new salle("23","111", "111",new salle_position(407.5,-698,101.5),new salle_size(100,75,100), salle_form.Square, salle_direction.Oblique),
			  new salle("24","112", "112",new salle_position(307.5,-698,101.5),new salle_size(100,75,100), salle_form.Square, salle_direction.Oblique),
			  new salle("25","113", "113",new salle_position(220,-698,101.5),new salle_size(75,75,100), salle_form.Square, salle_direction.Oblique),
			  ...
			  new salle("29","121", "121",new salle_position(-305,-660,101.5),new salle_size(175,150,100), salle_form.Trapezoid, salle_direction.Oblique),
			  new salle("28","120", "Shannon",new salle_position(-150,-660,101.5),new salle_size(135,150,100), salle_form.Square, salle_direction.Oblique),
			  ...
			  new salle("33","127","127",new salle_position(390,105,101.5),new salle_size(70,140,100),salle_form.Square,salle_direction.Horizontal),
			  new salle("34","128","Scolarité",new salle_position(305,105,101.5),new salle_size(100,140,100),salle_form.Square,salle_direction.Horizontal),
			            //"35
			  new salle("36","201", "201",new salle_position(-87.5,73.5,203),new salle_size(175,100,100),salle_form.Square,salle_direction.Vertical),
			  new salle("37","202", "202",new salle_position(-225,61,203),new salle_size(100,125,100),salle_form.Square,salle_direction.Vertical),
			  new salle("38","203", "203",new salle_position(-300,61,203),new salle_size(50,125,100),salle_form.Square,salle_direction.Vertical),
			  new salle("39","204", "204",new salle_position(-350,61,203),new salle_size(50,125,100),salle_form.Square,salle_direction.Vertical),
			  new salle("40","205", "205",new salle_position(-400,61,203),new salle_size(50,125,100),salle_form.Square,salle_direction.Vertical),
			  new salle("41","206", "206",new salle_position(-450,61,203),new salle_size(50,125,100),salle_form.Square,salle_direction.Vertical),
			  new salle("42","207", "207",new salle_position(-500,61,203),new salle_size(50,125,100),salle_form.Square,salle_direction.Vertical),
			  new salle("43","208", "208",new salle_position(-550,61,203),new salle_size(50,125,100),salle_form.Square,salle_direction.Vertical),
			  new salle("44","209", "209",new salle_position(-637.5,61,203),new salle_size(125,125,100),salle_form.Trapezoid,salle_direction.Vertical),
			  new salle("45","211", "211",new salle_position(-498,202.5 + v2,203),new salle_size(59,105,100),salle_form.Square,salle_direction.Vertical),
			  new salle("46","212", "212",new salle_position(-439,202.5 + v2,203),new salle_size(59,105,100),salle_form.Square,salle_direction.Vertical),
			  new salle("47","213", "213",new salle_position(-380,202.5 + v2,203),new salle_size(59,105,100),salle_form.Square,salle_direction.Vertical),
			  new salle("48","214", "214",new salle_position(-321,202.5 + v2,203),new salle_size(59,105,100),salle_form.Square,salle_direction.Vertical),
			  new salle("49","215", "215",new salle_position(-262,202.5 + v2,203),new salle_size(59,105,100),salle_form.Square,salle_direction.Vertical),
			  new salle("50","216", "216",new salle_position(507.5,-660,203),new salle_size(100,150,100), salle_form.Square, salle_direction.Oblique),
			  new salle("51","217", "217",new salle_position(407.5,-698,203),new salle_size(100,75,100), salle_form.Square, salle_direction.Oblique),
			  ...
			  new salle("53","220", "Lab visuel",new salle_position(207.5,-660,203),new salle_size(100,150,100), salle_form.Square, salle_direction.Oblique),
			  ...
			  new salle("58","229","229",new salle_position(675,37.5,203),new salle_size(120,75,100),salle_form.Square,salle_direction.Horizontal),
...
var points = {	0: {pos:new THREE.Vector3( 140,120,-30), direction:  salle_direction.Vertical},
				...
				77: {pos: new THREE.Vector3(190,35,-30), direction:  salle_direction.Vertical},
